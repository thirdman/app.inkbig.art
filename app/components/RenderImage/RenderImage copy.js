...
*/
    ...
    return (
      <div
        className={`${styles.RenderImage} ${styles[displayMode]} ${
      ...
      >
        ...
        >
          ...
          <div className={styles.column}>
            ...
            <button onClick={() => this.toggleViewRendered()}>
              {showRendered ? "hide render" : "Show render"}
            </button>
          </div>
        </div>
        <div
          className={`${styles.row} ${showRendered ? styles.isvisible : ""} ${
            this.state.showDetail ? styles.visible : styles.invisible
          }`}
        >
          <div className={styles.column}>
